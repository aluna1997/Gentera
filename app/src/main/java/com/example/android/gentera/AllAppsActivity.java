...
public class AllAppsActivity extends ListActivity {
    private static final String TAG = AllAppsActivity.class.getSimpleName();
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Toast.makeText(getApplicationContext(),String.valueOf(applist),Toast.LENGTH_SHORT).show();
        ...
        for (ApplicationInfo info : list) {
            try {
                if (null != packageManager.getLaunchIntentForPackage(info.packageName)) {
                    applist.add(info);
                    Log.i(TAG,String.valueOf(applist));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
